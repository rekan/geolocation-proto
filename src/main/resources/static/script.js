    ...
    function showError(error) {
        switch(error.code) {
            case error.PERMISSION_DENIED:
                geolocationDataPanel.innerHTML = "User denied the request for Geolocation."
                break;
            case error.POSITION_UNAVAILABLE:
                geolocationDataPanel.innerHTML = "Location information is unavailable."
                break;
            case error.TIMEOUT:
                geolocationDataPanel.innerHTML = "The request to get user location timed out."
                break;
            case error.UNKNOWN_ERROR:
                geolocationDataPanel.innerHTML = "An unknown error occurred."
                break;
        }
    }
